package com.carry.controller.provider;
...
public class ProviderController {
    ...
    public String query(String queryProName, String queryProCode, String pageIndex, HttpServletRequest req) {
    ...
    public String getProviderById(String proid, HttpServletRequest req){
    ...
    public String toModify(String proid, HttpServletRequest req){
        Provider provider = providerService.getProviderById(Integer.parseInt(proid));
        req.setAttribute("provider",provider);
